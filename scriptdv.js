function createFlower() {
    const flowerContainer = document.querySelector(".magicflowers");

    // Número máximo de flores en pantalla
    const maxFlowersOnScreen = 8;

    // Verificar si ya hay 10 flores en pantalla
    if (document.querySelectorAll(".showflowery").length >= maxFlowersOnScreen) {
    ...
    const flowerSize = 80; // Tamaño de la flor
